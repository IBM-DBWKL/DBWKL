...
import com.ibm.db2wkl.helper.DateUtility;
import com.ibm.db2wkl.logging.helper.LogHelper;
import com.ibm.db2wkl.logging.output.HTMLLogger;
import com.ibm.db2wkl.logging.output.TextLogger;
import com.ibm.db2wkl.rmi.LoggerRemoteInterface;
...
/*	public static ArrayList<ILoggerService> getCopyOfRequestLoggers() {
	...
	*/
	...
	/**
	 * @see com.ibm.db2wkl.logging.helper.LogHelper#logNewSession()
	 */
	 ...
	 * @see com.ibm.db2wkl.logging.helper.LogHelper#logConnectionInformation(Connection)
	 */
	 ...
	 * @see com.ibm.db2wkl.logging.helper.LogHelper#logSQLException(SQLException, String)
	 */
	...
	/**
	 * @param exception to log
	 * @see com.ibm.db2wkl.logging.helper.LogHelper#logException(Exception)
	 */
...
//	}
	...
	/* (non-Javadoc)
	 * @see com.ibm.db2wkl.rmi.LoggerRemoteInterface#Log(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, int, java.lang.String, java.lang.String)
	 */
	@Override
