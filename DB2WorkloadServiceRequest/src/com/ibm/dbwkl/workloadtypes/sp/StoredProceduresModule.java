...
import com.ibm.dbwkl.workloadtypes.AStoredProceduresModule;
...
public class StoredProceduresModule extends AStoredProceduresModule {
	...
	/*
	 * @see
	 * com.ibm.dbwkl.workloadservice.AWorkloadService#init(
	...
	/*
	 * @see
	 * com.ibm.dbwkl.workloadservice.AWorkloadService#execute
	 * (java.util.Properties, java.lang.String)
	 */
	@Override
	...
	/*
	 * @see
	 * com.ibm.dbwkl.workloadservice.AWorkloadService#clean
	 * (java.util.Properties, java.lang.String)
	 */
	@Override
	...
	/*
	 * @see
	 * com.ibm.dbwkl.workloadservice.AWorkloadService#getCommand
	 * ()
	 */
	@Override
	...
	/*
	 * @see com.ibm.dbwkl.workloadservice.AWorkloadService#
	 * getDescription()
	 */
	@Override
	...
	/*
	 * @see
	 * com.ibm.dbwkl.workloadservice.AWorkloadService#getName()
	 */
	@Override
