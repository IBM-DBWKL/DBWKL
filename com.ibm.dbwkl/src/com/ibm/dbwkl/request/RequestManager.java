...
import com.ibm.dbwkl.DB2WorkloadService;
import com.ibm.dbwkl.DB2WorkloadServiceDirectory;
import com.ibm.dbwkl.STAFHandler;
import com.ibm.dbwkl.helper.CaseInsensitiveArrayList;
import com.ibm.dbwkl.helper.CryptionModule;
import com.ibm.dbwkl.helper.Settings;
import com.ibm.dbwkl.helper.TwoKeysMap;
...
import com.ibm.dbwkl.request.RequestType;
import com.ibm.dbwkl.request.internal.HelpHandler;
import com.ibm.dbwkl.request.internal.InternalRequest;
import com.ibm.dbwkl.request.internal.ListHandler;
import com.ibm.dbwkl.request.internal.LoggingHandler;
import com.ibm.dbwkl.request.internal.MiscHandler;
import com.ibm.dbwkl.request.internal.ReportHandler;
import com.ibm.dbwkl.request.internal.RequestHandler;
import com.ibm.dbwkl.request.internal.SetupHandler;
import com.ibm.dbwkl.request.internal.VersionHandler;
import com.ibm.dbwkl.request.parser.Options;
import com.ibm.dbwkl.rmi.RequestManagerRemoteInterface;
import com.ibm.dbwkl.rmi.RequestRemoteInterface;
...
public class RequestManager implements RequestManagerRemoteInterface {
	...
	private STAFResult startNewJVMForRequest(ARequest request) {
		...
		command.add("com.ibm.dbwkl.request.RequestPerformer");
...
// 		ProcessBuilder pb = new ProcessBuilder(b);
		...
		//this loop checks whether the new process(JVM) exit before the request is added to the remoteRequest map via RMI.(see com.ibm.dbwkl.request.RequestPerformer)
